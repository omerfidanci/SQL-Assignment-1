...
*/
SELECT order_id, SUM(quantity) as productQuantity
...
--> The apperiance of the list has completely changed. In the first one, ordered by brand_id, looks like they are grouped by brand. 
However, in the second one, the list ordered by the price. 

The expected output should fit to your intend.
*/
